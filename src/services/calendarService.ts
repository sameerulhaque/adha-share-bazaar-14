...
const mockSlaughterEvents: CalendarEvent[] = [
  ...
  { id: 2, date: new Date(2025, 4, 22).toISOString(), animals: ["Medium Cow", "Standard Goat"], location: "East Facility", type: 'slaughter' },
  { id: 3, date: new Date(2025, 4, 25).toISOString(), animals: ["Large Cow", "Premium Goat"], location: "West Facility", type: 'slaughter' },
  { id: 4, date: new Date(2025, 4, 27).toISOString(), animals: ["Premium Cow", "Medium Goat"], location: "North Facility", type: 'slaughter' },
  { id: 5, date: new Date(2025, 4, 29).toISOString(), animals: ["Standard Cow", "Large Goat"], location: "South Facility", type: 'slaughter' },
  { id: 6, date: new Date(2025, 5, 2).toISOString(), animals: ["Premium Cow", "Medium Goat"], location: "Central Facility", type: 'slaughter' },
  { id: 7, date: new Date(2025, 5, 5).toISOString(), animals: ["Large Cow", "Standard Goat"], location: "East Facility", type: 'slaughter' },
  { id: 8, date: new Date(2025, 5, 8).toISOString(), animals: ["Medium Cow", "Premium Goat"], location: "West Facility", type: 'slaughter' },
  { id: 9, date: new Date(2025, 5, 11).toISOString(), animals: ["Premium Cow", "Large Goat"], location: "North Facility", type: 'slaughter' },
  { id: 10, date: new Date(2025, 5, 15).toISOString(), animals: ["Standard Cow", "Medium Goat"], location: "South Facility", type: 'slaughter' },
];
